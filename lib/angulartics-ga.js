...
.config(['$analyticsProvider', function ($analyticsProvider) {
  ...
  $analyticsProvider.registerPageTrack(function (path) {
    ...
    if (window.ga) {
      ...
      // set the document location manually (needed for single page application)
      ga('set', '&dl', document.location.origin + path)
      ga('set', '&dh', document.location.origin)
   ...
   * @name exceptionTrack
   *
   * @param {object} properties Comprised of required property description and optional property fatal
   *
  ...
  $analyticsProvider.registerExceptionTrack(function (properties) {
    if (!properties || !properties.description) {
        console.log('properties.description must be set; aborting hit');
        return;
    }

    properties.exDescription = properties.description;
    properties.exFatal = properties.exFatal;

    if(typeof properties.exFatal === 'undefined') {
